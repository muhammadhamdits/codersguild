    ...
    <div class="box">
        ...
        <form enctype="multipart/form-data" class="form-horizontal" role="form" action="proses.php" method="POST">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" class="form-control" name="nim" id="nim" placeholder="Enter NIM" required autofocus>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" class="form-control" id="nama" name="nama" required placeholder="Enter Name">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" class="form-control" id="tmp_lahir" name="tmp_lahir" placeholder="Enter Place" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input id="tgl_lahir" type="date" class="form-control" name="tgl_lahir" id="tgl_lahir">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" class="form-control" id="sma" name="sma" placeholder="Enter Highschool">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <textarea class="form-control" rows="5" id="alamat" name="alamat" placeholder="Enter Address"></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" class="form-control" id="no_hp" name="no_hp" placeholder="Enter Phone Number" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" class="form-control" id="hobi" name="hobi" placeholder="Enter Hobby">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <textarea class="form-control" rows="5" id="prestasi" name="prestasi" placeholder="Enter Achievement"></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <textarea class="form-control" rows="5" id="skill" name="skill" placeholder="Enter Skill"></textarea>
                </div>
            </div>
            ...
            <div class="form-group"> 
                <div class="col-sm-offset-3 col-sm-3">
                    <button type="submit" class="btn btn-md btn-success" name="add">DAFTAR</button>
